...
$obj = new User();
?>
<h1>Siswa Kelas X SMP Harapan Bangsa</h1>
...
<input type ="submit" class="tombol1" name = "kelasvii" value = "SISWA KELAS X">
 </form>
 
<form action = "siswa_xi.php" method ="POST" name="kelasxi">
<input type ="submit" class="tombol2" name = "kelasviii" value = "SISWA KELAS XI">
 </form>
